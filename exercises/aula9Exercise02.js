...
let cubeMaterials = [
    setMaterial('../assets/textures/tiles.jpg', 0.33,0.33, 0, 0), //x+
    setMaterial('../assets/textures/tiles.jpg', 0.33,0.33, 0.66, 0), //x-
    setMaterial('../assets/textures/tiles.jpg', 0.33,0.33, 0, 0.33), //x-
    setMaterial('../assets/textures/tiles.jpg', 0.33,0.33, 0.33, 0.33), //y+
    setMaterial('../assets/textures/tiles.jpg', 0.33,0.33, 0.66, 0.33), //y-
    setMaterial('../assets/textures/tiles.jpg', 0.33,0.33, 0.66, 0.66), //y-
];
...
function setMaterial(file, repeatU = 1, repeatV = 1,offsetX, offsetY){
