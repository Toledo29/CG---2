...
function keyboardUpdate() {
   ...
   keyboard.pressed("left") ? cameraHolder.rotateY(1) : null;
   keyboard.pressed("right") ? cameraHolder.rotateY(-1) : null;
   keyboard.pressed("up") ? cameraHolder.rotateX(1) : null;
   keyboard.pressed("down") ? cameraHolder.rotateX(-1) : null;
   keyboard.pressed("Q") ? cameraHolder.rotateZ(1) : null;
   keyboard.pressed("E") ? cameraHolder.rotateZ(-1) : null;

   keyboard.pressed("A") ? cameraHolder.translateX(-0.1) : null;
   keyboard.pressed("D") ? cameraHolder.translateX(0.1) : null;
   keyboard.pressed("W") ? cameraHolder.translateZ(-0.1) : null;
   keyboard.pressed("S") ? cameraHolder.translateZ(0.1) : null;
